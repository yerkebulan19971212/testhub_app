from .flash_card import FlashCardFilter
...
from .generation import TopicFilter
from .university import CountryFilter, UniversityFilter, UniversitySpecialityFilter
